...
<body>
	<!-- 폼전송 : insert는 무조건 post 방식 -->
	<form action="insertAction.jsp" method="post">
		<table class="table table-borderd" style="width: 350px;">
			<tr>
				<th>이름</th>
			...
			<tr>
				<td colspan="2" align="center"><input type="submit" value="전송"
					class="btn btn-info"> <input type="button" value="목록"
					onclick="location.href='infoList.jsp'" class="btn btn-danger"></td>
			</tr>
		</table>
	</form>
</body>
