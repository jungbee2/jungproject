			...
			<caption>
				...
				<tr>
					...
					<input type="text" name="hp2" size="3"
						required="required" onkeyup="goFocus(this)" value="<%=hp2%>">
						<b>-</b> <input type="text" name="hp3" size="3"
						required="required" value="<%=hp3%>"></td>
				</tr>
				...
				<tr>
					<td colspan="2"><input type="submit" value="db수정"
						class="btn btn-warning"> <input type="button" value="목록"
						onclick="location.href='sslist.jsp'" class="btn btn-warning"></td>
				</tr>
