 ...
 <div id="wrap">
        ...
        <div id="header" class="box">
            ...
            <div id="contentWrap">
                <div id="content">
                    <div class="cate-wrap">
                        <div class="bcate"><a href="" class="-mos"><%= category %></a></div>
                    </div>

                    <div class="total-sort">
                        <div class="total">
                            TOTAL <strong><%= total %></strong> EA
                        </div>
                            ...
                            <li class="">
                                <div class="item-box ">
                                    <div class="item-thumb mos03">
                                        <a href="object.jsp?name=<%=list.get(i).getName()%>"><img class="" src="object_photo/<%=list.get(i).getPhoto()%>"/></a>
                                        <div class="item-info">
                                            <p class="item-name"><%=list.get(i).getName()%></span></p>
                                            <span class="snap_review_count noset" snap_item_id=""></span>
                                            <p class="item-price"><%=list.get(i).getPrice()%></p>
                                        </div>
                                    </div>
                                </div>
                            </li>
