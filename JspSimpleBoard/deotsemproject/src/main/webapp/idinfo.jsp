        ...
        <div id="contentWrapper">
            <div id="contentWrap">
                <div id="content">
                    ...
                    <div class="cate-wrap">
                        <div class="bcate"><a href="" class="-mos">비밀번호 재확인</a></div>
                    </div>
                            ...
                            <div id="content">
                                <div id="reconfirmPasswd">
                                    ...
                                    <div class="reconfirmTop">
                                        <h2>비밀번호 재확인</h2>
                                        <p class="txt">저희 쇼핑몰에서는 회원님의 소중한 개인정보를 안전하게 보호하고<br />개인정보 도용으로 인한 피해를 예방하기 위하여
                                            비밀번호를 확인합니다.<br />비밀번호는 타인에게 노출되지 않도록 주의해주세요.</p>
                                    </div>

                                    <form name="form_pw" id="form_pw" action="/shop/reconfirm_password.action.html"
                                        method="POST" autocomplete="off" onsubmit="return false;">
                                        <input type="hidden" name="page_mode" value="PC">
                                        <input type="hidden" name="hidden_login_id" value="jungb1203">
                                        ...
                                        <fieldset>
                                            <legend>비밀번호 재확인 폼</legend>
                                            <div class="frm">
                                                <ul>
                                                    <li>
                                                        <span class="lab">ID</span>
                                                        <strong>jungb1203</strong>
                                                    </li>
                                                    <li>
                                                        <span class="lab">PASSWORD</span>
                                                        <label><span>ENTER PASSWORD</span><input type="password"
                                                                id="user_password" name="user_password"
                                                                class="txt-input"
                                                                onkeyup="javascript:check_key(event);"></label>
                                                    </li>
                                                </ul>
                                            </div><!-- .frm -->
                                            <div class="btns">
                                                <a href="javascript:pw_check();" class="CSSbuttonBlack">확인</a>
                                                <a href="/index.html" class="CSSbuttonWhite">취소</a>
                                            </div><!-- .btns -->
                                        </fieldset>
                                    </form>
                                </div><!-- #reconfirmPasswd -->
