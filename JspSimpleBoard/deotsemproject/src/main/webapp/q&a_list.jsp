        ...
        <div id="contentWrapper">
            <div id="contentWrap">
                <div id="content">
                   ...
                   sql = "select count(*) from qna_db"; //db내의 자료개수를 찾는 문
                   ...
                   int sort=1;
                   String sqlSort = "SELECT num from qna_db order by ref desc, step asc";
                   ...
                   String sqlList = "SELECT num, name, title, time, hits, indent from qna_db order by ref DESC, step ASC";
...
%> 
<a href="q&a_view.jsp?idx=<%=idx%>"><%=title %></td>
...
%>
                                ...
                                <div class="boardWrite"><a href="q&a_writer.jsp"  class="btn_Red">글쓰기</a></div>
