     ...
     <div id="wrap">
        ...
        <div id="contentWrapper">
            <div id="contentWrap">
                <div id="content">
                    <div class="cate-wrap">
                        <div class="bcate"><a href="" class="-mos">NOTICE</a></div>
                    </div>
...
<% 
  ...
  for ( int i = 0; i < list.size(); i++) {
	  ...
	  %>
	  <tr>
	  <td align="center"><a href="notice_view.jsp?num=<%=list.get(i).getNum()%>"><%=list.get(i).getNum()%></a></td>
	  <td align="center"><a href="notice_view.jsp?num=<%=list.get(i).getNum()%>"><%=list.get(i).getTitle()%></td>
	  <td align="center"><%=list.get(i).getName()%></td>
	  <td align="center"><%=list.get(i).getHits()%></td> 
	 </tr>
...
%>
  ...
  <%
    ...
    if(pageNumber != 1) {
    %>
    	<a href="notice_list.jsp?pageNumber=<%=pageNumber - 1%>"><span class="list_prev_btn">문의사항 이전 버튼</span></a>
    <%	
    } if(noticeDAO.nextPage(pageNumber + 1)){
   %>


    	<a href="notice_list.jsp?pageNumber=<%=pageNumber + 1%>"><span class="list_next_btn">문의사항 다음 버튼</span></a>
   <%
    }
  %>
  </div>
<div class="write_box"><a href="notice_writer.jsp">글쓰기</a></div>
                                <br>
                                <br>
                                <br>
                                <br>
