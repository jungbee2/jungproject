 ...
 <div id="wrap">
        ...
        <div id="contentWrapper">
            <div id="contentWrap">
                <div id="content">
                    <div class="cate-wrap">
                        <div class="bcate"><a href="" class="-mos">REVIEW</a></div>
                    </div>
	...
	sql = "select count(*) from notice_db"; //db내의 자료개수를 찾는 문
	ResultSet rs = stmt.executeQuery(sql); // DB실행
	
	if(rs.next()){ // rs.next()의 반환값은 true or false
		total = rs.getInt(1); // select 문의 첫번째 필드 count(*)
	}
	
	int sort=1;
	String sqlSort = "SELECT num from notice_db order by ref desc, step asc";
	...
	String sqlList = "SELECT num, name, title, time, hits, indent from notice_db order by ref DESC, step ASC";
                            ...
                            <main id="review-board-list">
                                ...
                                <div class="content_row_1">
                                    <table class="board_table">
                                        ...
                                        %> 
                                        <a href="notice_view.jsp?idx=<%=idx%>"><%=title %></td>
                                ...
                                <div class="boardWrite"><a href="notice_writer.jsp"  class="btn_Red">글쓰기</a></div>
                                ...
                                <div class="content_row_3">
                                    ...
                                    <a href="sub_notice.html">1</a>
                                    <a href="sub_notice2.html">2</a>
