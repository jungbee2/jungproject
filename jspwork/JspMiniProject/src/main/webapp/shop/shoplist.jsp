...
<body>
  ...
  <ul class="nav nav-tabs">
		...
		<p>
			<table class="table table-bordered" style="width: 1000px;">
				<caption><b>전체상품목록</b></caption>
					<tr>
						<%
						NumberFormat nf=NumberFormat.getCurrencyInstance(); //가격표시, 천단위 구분기호
						int i=0;
	...
	<div id="tabs-2"  class="tab-pane fade">
		<p>
			<table class="table table-bordered" style="width: 1000px;">
				<caption><b>피규어목록</b></caption>
					<tr>
						<%
						nf=NumberFormat.getCurrencyInstance(); //가격표시, 천단위 구분기호
						i=0;
