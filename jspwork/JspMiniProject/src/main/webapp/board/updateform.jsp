...
<body>
<form action="board/upadateaction.jsp" method="post" >
	
      <!-- 수정폼은 반드시  num, currentPage도 같이 hidden으로 넘긴다. -->
	...
	<table class="table table-bordered" style="width: 800px; margin-left: 100px;">
		<caption style="caption-side: top;"><h3>스마트 포토 게시판</h3></caption>
		<tr>
			<th bgcolor="lightgray" width="100" style="text-align: center">작성자</th>
			<td>
		...
		<tr>
			<th bgcolor="#E1EEDD" width="100" style="text-align: center">제목</th>
			<td>
		...
		<tr>
			<td colspan="2" align="center">
				<button type="button" class="btn btn-warning"
					style="width: 120px;"
					onclick="submitContents(this)">DB 수정</button>
